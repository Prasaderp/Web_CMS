    ...
    <div className="font-inter bg-gradient-to-b from-white to-[#f8faff] text-gray-800">
      ...
      <section className="py-20 bg-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          {[
            { icon: '⚙️', title: 'Business Automation', desc: 'AI-driven automation to eliminate manual operations.' },
            { icon: '📊', title: 'Business Intelligence', desc: 'Advanced dashboards and real-time analytics.' },
            { icon: '☁️', title: 'Cloud Migration', desc: 'Secure and scalable cloud transformation strategies.' },
            { icon: '🔐', title: 'Enterprise Security', desc: 'Cybersecurity frameworks and data protection.' },
            { icon: '🧩', title: 'ERP & CRM', desc: 'Integrated enterprise platforms for operations & sales.' },
            { icon: '🗄️', title: 'Data Warehousing', desc: 'Centralized, reliable enterprise data infrastructure.' }
          ].map((f, i) => (
