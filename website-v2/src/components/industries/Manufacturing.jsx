    ...
    <div className="font-inter bg-gradient-to-b from-white to-[#f8faff] text-gray-800">
      ...
      <section className="py-20 bg-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          {[
            { icon: '🏭', title: 'Smart Factory', desc: 'Digitally connected and automated manufacturing plants.' },
            { icon: '🔧', title: 'Predictive Maintenance', desc: 'AI-based failure prediction & reduced downtime.' },
            { icon: '📡', title: 'Industrial IoT', desc: 'Real-time equipment monitoring and insights.' },
            { icon: '📦', title: 'Supply Chain Optimization', desc: 'Data-driven logistics and inventory management.' },
            { icon: '🤖', title: 'Robotics Integration', desc: 'Intelligent automation for production lines.' },
            { icon: '✅', title: 'Quality Control', desc: 'AI-powered inspection and defect detection.' }
          ].map((f, i) => (
