    ...
    <div className="font-inter bg-gradient-to-b from-white to-[#f8faff] text-gray-800">
      ...
      <section className="py-20 bg-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          {[
            { icon: '🛡️', title: 'Fraud Detection', desc: 'AI models that detect suspicious transactions in real-time.' },
            { icon: '🏦', title: 'Digital Banking', desc: 'End-to-end digital banking and neobank platforms.' },
            { icon: '📉', title: 'Risk Management', desc: 'Automated credit scoring and risk assessment.' },
            { icon: '⛓️', title: 'Blockchain Payments', desc: 'Secure, fast, and transparent payment systems.' },
            { icon: '📊', title: 'Financial Analytics', desc: 'Actionable insights for revenue, cost, and growth.' },
            { icon: '📜', title: 'RegTech', desc: 'Compliance automation for global financial regulations.' }
          ].map((f, i) => (
