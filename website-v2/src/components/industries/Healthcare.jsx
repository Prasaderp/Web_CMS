...
const Healthcare = () => {
  ...
  return (
    <>
        <SEO
            title="Intelligent Healthcare Solutions - AiGENThix"
    ...
    <div className="font-inter bg-gradient-to-b from-white to-[#f8faff] text-gray-800">
      ...
      <section className="py-20 bg-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          {[
            { icon: '🧠', title: 'Clinical AI', desc: 'AI-assisted diagnostics, medical imaging & prediction systems.' },
            { icon: '🩺', title: 'Telemedicine', desc: 'Secure virtual consultations and remote monitoring platforms.' },
            { icon: '📋', title: 'EHR Systems', desc: 'Interoperable electronic health records with analytics.' },
            { icon: '🔐', title: 'HIPAA Security', desc: 'Data privacy, encryption & healthcare-grade security.' },
            { icon: '📊', title: 'Health Analytics', desc: 'Actionable insights from complex patient data.' },
            { icon: '🤖', title: 'AI Assistants', desc: 'Virtual healthcare assistants for staff & patients.' }
          ].map((f, i) => (
