...
const GenerativeAI = () => {
  ...
  return (
    <>
        <SEO
            title="Generative AI Training - Build Next-Gen AI Applications"
            description="Learn to build next-generation applications using LLMs, multimodal models, AI agents, and creative generation systems. Our Generative AI training covers prompt engineering, model fine-tuning, tool integration, and real-world projects for practical skills."
            url="/learning-and-development/generative-ai"
    ...
    <div className="bg-white text-gray-900 font-['Poppins',sans-serif]">
        ...
        >
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Build next-generation applications using LLMs, multimodal models,
              AI agents, and creative generation systems.
            </p>
          ...
          <img
            src="https://bizzi.vn/wp-content/uploads/2025/11/generative-ai-la-gi.jpg"
            alt="Generative AI"
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-10">
            Become industry-ready to build production-grade generative AI systems.
          </p>
      ...
      <section className="py-24 bg-blue-600 text-white text-center px-6">
        ...
        <p className="mb-8 max-w-2xl mx-auto text-blue-100">
          Learn to design intelligent creative systems with real-world projects.
        </p>
        <Link
          to="/contact"
