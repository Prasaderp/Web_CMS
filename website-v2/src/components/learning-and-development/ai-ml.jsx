...
const AIMachineLearning = () => {
  ...
  return (
    <>
        <SEO
            title="AI & Machine Learning Training - Build Intelligent Systems"
            description="Learn to build intelligent systems using supervised, unsupervised, and deep learning techniques for real-world problems. Our AI & Machine Learning training covers algorithms, model evaluation, feature engineering, and AI system design for practical applications."
            url="/learning-and-development/ai-machine-learning"
            image="/ai-ml-og.jpg"
        />
    <div className="bg-white text-gray-900 font-['Poppins',sans-serif]">
        ...
        >
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Build intelligent systems using supervised, unsupervised, and deep
          ...
          <img
            src="https://techcmantix.com/wp-content/uploads/2024/10/Artificial-Intelligence.webp"
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-10">
            Become industry-ready to build and deploy machine learning systems.
          </p>
      ...
      <section className="py-24 bg-blue-600 text-white text-center px-6">
        <h3 className="text-3xl md:text-4xl font-bold mb-4">
          Build Intelligent Systems with AI
        </h3>
        <p className="mb-8 max-w-2xl mx-auto text-blue-100">
          Learn to solve real-world problems using machine learning and AI.
        </p>
        <Link
          to="/contact"
