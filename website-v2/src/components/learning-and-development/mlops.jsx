...
const AIMLOps = () => {
  return (
    <>
        <SEO
            title="AI & MLOps Training - Deploy & Scale AI Models - AiGENThix"
    ...
    <div className="bg-white text-gray-900 font-['Poppins',sans-serif]">
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <img
            src="https://cdn.shopaccino.com/igmguru/articles/green-and-white-modern-artificial-intelligence-presentation-1-5502170686247_l.jpg?v=546"
            alt="AI MLOps"
